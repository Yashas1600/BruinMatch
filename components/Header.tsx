...
export default function Header() {
  ...
  return (
    <div className="max-w-md mx-auto mb-4 relative flex items-center justify-between px-1">
      {pathname === '/swipe' ? (
        <>
        ...
        <>
          ...
          {pathname === '/preferences' && (
            <button
              ...
              className="px-4 py-2 bg-primary-50 rounded-full text-primary-500 font-medium text-sm hover:bg-primary-100 transition"
            >
              Log out
            </button>
          )}
